...
def train_stacking_classifier(fits_input_path,verbose=False):
    """
    ...
    # Get best models
    clf_ab = train_best_adaboost(X_train, y_train)
    clf_rf = best_RF(X_train, y_train)
    clf_svm = train_best_svm(X_train, y_train)
    clf_gmm = best_GMM()
